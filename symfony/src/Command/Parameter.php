...
class Parameter
{
    ...
    public static function fromPath(Path $path, array $data): self
    {
        return new self($path, null, $data);
    }

    public static function fromOperation(Operation $operation, array $data): self
    {
        return new self(null, $operation, $data);
    }
