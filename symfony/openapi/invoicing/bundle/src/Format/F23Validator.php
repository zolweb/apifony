...
class F23Validator extends ConstraintValidator
{
    private F23Definition $formatDefinition;

    public function setFormatDefinition(F23Definition $formatDefinition): void
    {
