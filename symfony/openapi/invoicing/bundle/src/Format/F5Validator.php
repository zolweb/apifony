...
class F5Validator extends ConstraintValidator
{
    private F5Definition $formatDefinition;

    public function setFormatDefinition(F5Definition $formatDefinition): void
    {
