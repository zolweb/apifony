...
class F17Validator extends ConstraintValidator
{
    private F17Definition $formatDefinition;

    public function setFormatDefinition(F17Definition $formatDefinition): void
    {
