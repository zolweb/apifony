...
class F12Validator extends ConstraintValidator
{
    private F12Definition $formatDefinition;

    public function setFormatDefinition(F12Definition $formatDefinition): void
    {
