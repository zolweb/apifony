...
class F25Validator extends ConstraintValidator
{
    private F25Definition $formatDefinition;

    public function setFormatDefinition(F25Definition $formatDefinition): void
    {
