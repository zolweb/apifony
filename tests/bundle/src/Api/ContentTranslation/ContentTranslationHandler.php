...
{
    public function postContentTranslationFromPostContentTranslationApplicationJsonRequestBodyPayloadPayloadToApplicationJsonContent(PostContentTranslationApplicationJsonRequestBodyPayload $requestBodyPayload): PostContentTranslation201EmptyResponse|PostContentTranslation400ApplicationJsonResponse|PostContentTranslation409ApplicationJsonResponse;
    ...
    public function getContentTranslationFromEmptyPayloadToApplicationJsonContent(string $pContentTranslationId): GetContentTranslation200ApplicationJsonResponse|GetContentTranslation404ApplicationJsonResponse;
    public function getContentTranslationDataVersionsFromEmptyPayloadToApplicationJsonContent(string $pContentTranslationId, int $qPageNumber, int $qPageSize): GetContentTranslationDataVersions200ApplicationJsonResponse;
    public function publishContentTranslationFromPublishContentTranslationApplicationJsonRequestBodyPayloadPayloadToApplicationJsonContent(string $pContentTranslationId, PublishContentTranslationApplicationJsonRequestBodyPayload $requestBodyPayload): PublishContentTranslation200EmptyResponse|PublishContentTranslation400ApplicationJsonResponse|PublishContentTranslation404ApplicationJsonResponse|PublishContentTranslation409ApplicationJsonResponse;
