            ...
            case is_null($requestBodyPayload):
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->getMediaListFromEmptyPayloadToApplicationJsonContent(
                            $qPageNumber,
                            $qPageSize,
                            $qSort,
                            $qSearch,
    ...
    public function postMedia(
        ...
        switch (true) {
            case $requestBodyPayload instanceOf PostMediaApplicationJsonRequestBodyPayload:
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->postMediaFromPostMediaApplicationJsonRequestBodyPayloadPayloadToApplicationJsonContent(
                            $requestBodyPayload,
                        );
    ...
    public function getMedia(
        ...
        switch (true) {
            case is_null($requestBodyPayload):
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->getMediaFromEmptyPayloadToApplicationJsonContent(
                            $pMediaId,
                        );
    ...
    public function patchMedia(
        ...
        switch (true) {
            case $requestBodyPayload instanceOf PatchMediaApplicationJsonRequestBodyPayload:
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->patchMediaFromPatchMediaApplicationJsonRequestBodyPayloadPayloadToApplicationJsonContent(
                            $pMediaId,
                            $requestBodyPayload,
                        );
    ...
    public function archiveMedia(
        ...
        switch (true) {
            case $requestBodyPayload instanceOf ArchiveMediaApplicationJsonRequestBodyPayload:
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->archiveMediaFromArchiveMediaApplicationJsonRequestBodyPayloadPayloadToApplicationJsonContent(
                            $pMediaId,
                            $requestBodyPayload,
                        );
