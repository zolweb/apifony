...
class MoveToMediaFolderApplicationJsonRequestBodyPayload
{
     ...
     */
    public function __construct(#[Assert\NotNull] public readonly int $version, #[Assert\NotNull] #[Assert\All(constraints: [new Assert\NotNull()])] public readonly array $movedMediaIds, #[Assert\NotNull] #[Assert\All(constraints: [new Assert\NotNull()])] public readonly array $movedMediaFolderIds, #[Assert\NotNull] public readonly string $destinationMediaFolderId)
    {
    }
}