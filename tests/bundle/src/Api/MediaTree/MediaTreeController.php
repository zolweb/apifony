...
class MediaTreeController extends AbstractController
{
            ...
            case is_null($requestBodyPayload):
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->getMediaTreeFromEmptyPayloadToApplicationJsonContent(
                            $qPath,
                        );
    ...
    public function moveToMediaFolder(
        Request $request,
    ): Response {
        $errors = [];
        ...
        switch (true) {
            case $requestBodyPayload instanceOf MoveToMediaFolderApplicationJsonRequestBodyPayload:
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->moveToMediaFolderFromMoveToMediaFolderApplicationJsonRequestBodyPayloadPayloadToApplicationJsonContent(
                            $requestBodyPayload,
                        );
    ...
    public function addMediaFolder(
        ...
        switch (true) {
            case $requestBodyPayload instanceOf AddMediaFolderApplicationJsonRequestBodyPayload:
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->addMediaFolderFromAddMediaFolderApplicationJsonRequestBodyPayloadPayloadToApplicationJsonContent(
                            $requestBodyPayload,
                        );
    ...
    public function getMediaFolder(
        ...
        switch (true) {
            case is_null($requestBodyPayload):
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->getMediaFolderFromEmptyPayloadToApplicationJsonContent(
                            $pMediaFolderId,
                        );
    ...
    public function updateMediaFolder(
        ...
        switch (true) {
            case $requestBodyPayload instanceOf UpdateMediaFolderApplicationJsonRequestBodyPayload:
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->updateMediaFolderFromUpdateMediaFolderApplicationJsonRequestBodyPayloadPayloadToApplicationJsonContent(
                            $pMediaFolderId,
                            $requestBodyPayload,
                        );
    ...
    public function deleteMediaFolder(
        ...
        switch (true) {
            case $requestBodyPayload instanceOf DeleteMediaFolderApplicationJsonRequestBodyPayload:
                switch($responsePayloadContentType) {
                    case 'application/json':
                        $response = $this->handler->deleteMediaFolderFromDeleteMediaFolderApplicationJsonRequestBodyPayloadPayloadToApplicationJsonContent(
                            $pMediaFolderId,
                            $requestBodyPayload,
                        );
